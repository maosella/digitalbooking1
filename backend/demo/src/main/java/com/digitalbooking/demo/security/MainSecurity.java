package com.digitalbooking.demo.security;


import com.digitalbooking.demo.security.JWT.JwtEntryPoint;
...
public class MainSecurity extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .antMatchers(HttpMethod.POST,"/reservations/**").hasAuthority("client")
